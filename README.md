...
1. V Add links to GH project in all places marked `TODO: ADD_LINK`
2. V Add name of the author in all places marked `TODO: ADD_AUTHOR`
3. V Search for any other places makred with `TODO:`
4. V Fill content of `src/Directory.Build.props`
...
* Sample documentation produced by the template can be found on http://kcieslak.io/SampleGogApi.Dotnet.
...
* Use FSharp.Formatting to create API reference for the project - sample: http://kcieslak.io/SampleGogApi.Dotnet/Reference/ApiRef.html
* Use [Lunr.js](https://lunrjs.com/) to provide client side search based on generated by Fornax search index - sample: try searching for `Lorem` or `Sample` in search available on http://kcieslak.io/SampleGogApi.Dotnet
* Use [Mermaid.js](https://mermaid-js.github.io/mermaid/#/) to provide client side render diagrams and graphs - sample: http://kcieslak.io/SampleGogApi.Dotnet/diagrams.html
